...
namespace TestingPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20251105100817_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestingPlatform.domain.Models.UserAttemptsAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TestingPlatform.domain.Models.UserSelectedOption", b =>
                {
                    ...
                    b.HasOne("TestingPlatform.domain.Models.Answer", null)
                        .WithMany("UserSelectedOptions")
                        .HasForeignKey("AnswerId1");

                    b.HasOne("TestingPlatform.domain.Models.UserAttemptsAnswer", "UserAttemptAnswer")
                        .WithMany("UserSelectedOptions")
